...
theorem open_celestial_amplitude_has_cut : True := trivial
...
theorem open_disc_equals_loop_integrand : True := trivial
...
theorem open_shadow_disc_mellin_density : True := trivial
