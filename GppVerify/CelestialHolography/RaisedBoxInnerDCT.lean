...
not claim the full simplex limit: domination and almost-everywhere pointwise
convergence on the affine slice remain explicit until they are discharged from
the concrete Symanzik geometry.
-/
...
hypotheses are precisely the a.e. domination and pointwise-limit obligations
that must be proved on the simplex slice. -/
